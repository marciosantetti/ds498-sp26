...
**001**: Introduction to `R`, `RStudio`, and the `tidyverse`
  ...
  - Data: [`toy_data.csv`](https://raw.githack.com/marciosantetti/ec103-sp23/main/lab/001-tidyverse/toy_data.csv) | Data can also be downloaded on `Canvas`
  - [`Video lecture`](https://youtu.be/SCOCBd1t7Ew)
  - [`Practice 1`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-1/practice-1-sp26.pdf)
...
**002**: Manipulating data in the `tidyverse`
  ...
  - [`Practice 2`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-2/practice-2-sp26.pdf)
...
**003**: Manipulating economic data with the `tidyverse`
  ...
  - Data: [`gdp-data.csv`](https://raw.githack.com/marciosantetti/ec103-fall22/main/lab/003-data-manipulation-2/gdp-data.csv) | Data can also be downloaded on `Canvas`
  - [`Video lecture`](https://youtu.be/z5ON3xXREiA)
  - [`Practice 3`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-3/practice-3-sp26.pdf)
...
**004**: The "grammar of graphics"
   ...
   - [`Practice 4`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-4/practice-4-sp26.pdf)
...
**005**: Making plots informative
  ...
  - Data: [`unemp-data.csv`](https://raw.githack.com/marciosantetti/ec103-fall22/main/lab/005-informative-plots/unemp-data.csv) | Data can also be downloaded on `Canvas`
  - [`Video lecture`](https://youtu.be/pMhebKitqqU)
  - [`Practice 5`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-5/practice-5-sp26.pdf)
...
**006**: Customizing and saving plots
   ...
   - Data: [`lab6_data.csv`](https://raw.githack.com/marciosantetti/ec103-fall22/main/lab/006-custom-plots/lab6_data.csv) | Data can also be downloaded on `Canvas`
   - [`Video lecture`](https://youtu.be/HMc9_Zumfa4)
   - [`Practice 6`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-6/practice-6-sp26.pdf)
 ...
 **007**: Dealing with dates
  ...
  - [`Practice 7`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-7/practice-7-sp26.pdf)
...
**008**: Variable classes
  ...
  - [`Practice 8`](https://raw.githack.com/marciosantetti/ds498-sp26/main/r-bootcamp/practice-8/practice-8-sp26.pdf)
